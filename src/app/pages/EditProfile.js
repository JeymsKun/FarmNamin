...
const EditProfileScreen = () => {
  ...
  return (
    ...
    >
      ...
      <Text style={styles.subExperienceTitle}>
        Months/Years of Farming Experience (optional if applicable){" "}
      </Text>
      ...
      <View style={styles.buttonRow}>
        <TouchableOpacity
          ...
          onPress={() => router.push("/pages/EditBasicInfo")}
        >
        ...
        <TouchableOpacity
          style={styles.editButton}
          onPress={() => router.push("/pages/EditAccount")}
        >
