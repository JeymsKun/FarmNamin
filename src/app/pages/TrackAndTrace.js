...
const ProductScreen = () => {
        ...
        <GestureDetector gesture={panGesture}>
          <Animated.View style={[styles.swipeableItem, animatedStyle]}>
            ...
            <Animated.View style={styles.deleteTagButton}>
              <TouchableOpacity
                onPress={() => handleDeleteTag(tag.description)}
              >
                <MaterialIcons name="delete" size={24} color="white" />
              </TouchableOpacity>
            </Animated.View>
  ...
  const handleDeleteTag = async (tagDescription) => {
    ...
    try {
      ...
      setSelectedTags((prevTags) =>
        prevTags.filter((tag) => tag.description !== tagDescription)
      );
    } catch (err) {
  ...
  const updatePieChartData = (
    ...
    const investmentPercentage =
      total > 0 ? (totalInvestment / total) * 100 : 0;
  ...
  useEffect(() => {
    const {
      ...
      totalInvestment,
      netBalance,
    } = calculateTotals(selectedBalances);
    updatePieChartData(
      totalIncome,
      totalExpense,
      totalSaving,
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerGreet}>
            <Text style={styles.headerTitleText}>
              Let's trace and track your finances.
            </Text>
          </View>
        </View>
          ...
          <View style={styles.rowDetailsPicker}>
            <View style={styles.detailsContainer}>
              <Text style={styles.textDetails}>
                You can view your overall finances here.
              </Text>
            </View>
                ...
                pieData.some((item) => item.population > 0) ? (
                  <>
                    <Text style={styles.textAmount}>
                      {`${formatAmount(
                        calculateTotals(selectedBalances).netBalance
                      )}`}
                    </Text>
                    <PieChart
                      data={pieData}
        ...
        <View style={styles.overviewContainer}>
          ...
          <View style={styles.detailsOverviewContainer}>
            <Text style={styles.textDetails}>
              You can set up a quick snapshot of your finances.
            </Text>
          </View>
          ...
          <View style={styles.placeholderOverviewBalanceContainer}>
            {selectedBalances.length === 0 ? (
              ...
              selectedBalances
                .slice(0, showAllBalances ? selectedBalances.length : 4)
                .map((group) => (
        ...
        <View style={styles.tagContainer}>
          ...
          <View style={styles.detailsTagContainer}>
            <Text style={styles.textTagDetails}>
              You can use tags to categories and track your monthly budget
              efficiently.
            </Text>
          </View>
          ...
          <View>
            {selectedTags.length === 0 ? (
              ...
              selectedTags
                .slice(0, showAllTags ? selectedTags.length : 4)
                .map((tag, index) => (
                  <SwipeableTagItem
                    key={index}
                    tag={tag}
        ...
        <View style={styles.createContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push("/pages/OverviewBalance")}
          >
