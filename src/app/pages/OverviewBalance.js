...
export default function OverviewBalance() {
  ...
  const [isConfirmationModalVisible, setIsConfirmationModalVisible] =
    useState(false);
  const [
    balanceDeleteConfirmationVisible,
    setBalanceDeleteConfirmationVisible,
  ] = useState(false);
  const [balanceConfirmationVisible, setBalanceConfirmationVisible] =
    useState(false);
  ...
  const handleAddTransaction = async () => {
    ...
    if (
      !trimmedDescription ||
      !validTypes.includes(trimmedType) ||
      isNaN(parsedAmount) ||
      parsedAmount <= 0
    ) {
      showAlert(
        "Invalid Type Format:",
        "Please ensure that the type format is followed."
      );
      return;
    }
  ...
  return (
    <>
      ...
      <ScrollView contentContainerStyle={styles.container}>
            ...
            {overviewBalance.length > 0 ? (
              overviewBalance.map((balance, index) => (
                <View key={index} style={styles.balanceWrapper}>
                  ...
                  {index < overviewBalance.length - 1 && (
        ...
        <View style={styles.inputContainer}>
          ...
          <View
            style={[
              styles.inputWrapper,
              amountFocused && amount.length === 0 && styles.errorBorder,
            ]}
          >
            <TextInput
              style={styles.input}
          ...
          <View
            style={[
              styles.inputWrapper,
              typeFocused && type.length === 0 && styles.errorBorder,
            ]}
          >
            <TextInput
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>
              Are you sure you want to create this overview balance?
            </Text>
      ...
      <Modal visible={isLoading} transparent={true} animationType="fade">
        ...
        >
          <View style={{ padding: 20, borderRadius: 10, alignItems: "center" }}>
            ...
            >
              Calculating your overview balance...
            </Text>
          </View>
        </View>
      </Modal>
      ...
      <Modal
        visible={balanceConfirmationVisible}
        transparent={true}
        animationType="fade"
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>
              Are you sure you want to add a new balance?
            </Text>
            <View style={styles.modalButtons}>
              <TouchableOpacity
                style={styles.modalButton}
                onPress={confirmAddNewBalance}
              >
                <Text style={styles.modalButtonTextYes}>Yes</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.modalButton}
                onPress={() => setBalanceConfirmationVisible(false)}
              >
                <Text style={styles.modalButtonTextNo}>No</Text>
              </TouchableOpacity>
            </View>
      ...
      <Modal
        visible={balanceDeleteConfirmationVisible}
        transparent={true}
        animationType="fade"
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>
              Are you sure you want to delete all balance?
            </Text>
            <View style={styles.modalButtons}>
              <TouchableOpacity
                style={styles.modalButton}
                onPress={confirmDeleteBalance}
              >
                <Text style={styles.modalButtonTextYes}>Yes</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.modalButton}
                onPress={() => setBalanceDeleteConfirmationVisible(false)}
              >
                <Text style={styles.modalButtonTextNo}>No</Text>
              </TouchableOpacity>
            </View>
