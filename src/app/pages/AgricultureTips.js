...
import agricultureTipsData from "../data/agricultureTipData";
...
const AgricultureTipsScreen = () => {
  ...
  const handleReadMore = () => {
    if (selectedTip) {
      router.push(
        `/support/WebBrowser?link=${encodeURIComponent(selectedTip.link)}`
      );
    }
  };
      ...
      <View style={styles.welcomeContainer}>
        ...
        <View style={styles.searchBarContainer}>
          <Text style={styles.searchTitle}>
            Search Smartly: Your Ultimate Guide to Agricultural Tips
          </Text>
