      ...
      >
        ...
        <View style={styles.container}>
          ...
          <View style={styles.inputWrapper}>
              ...
              <>
                ...
                >
                  ...
                  {emailFocused && email.length === 0 ? (
                    ...
                    <Text style={styles.errorText}>
                      * Email should be a '@gmail.com' address.
                    </Text>
                  ) : null}
                  {emailVerify && (
                    <Text style={styles.errorText}>
              ...
              >
                <Text style={styles.helperText}>
                  {usePhoneNumber
                    ...
                    : "Use Email Address to reset password"}
                </Text>
              </TouchableOpacity>
            </View>
            ...
            {verificationPhoneNumber && (
              <View
                style={[
                  styles.inputContainer,
                  smsOTPVerify && styles.errorBorder,
                ]}
              >
                <TextInput
                ...
                {smsOTPVerify && (
                  <Text style={styles.errorSMSEmailText}>
            ...
            {verificationEmail && (
              <View
                style={[
                  styles.inputContainer,
                  emailOTPVerify && styles.errorBorder,
                ]}
              >
                <TextInput
                  style={styles.inputSMSEmail}
          ...
          {activeVerification && (
            <>
              <TouchableOpacity
                ...
                onPress={() => router.push("/ChangePassword?role=", +role)}
              >
                {loading ? (
              ...
              >
                {loading ? (
                  ...
                  <Text style={styles.resendVerifyText}>Resend Code</Text>
                )}
              </TouchableOpacity>
            </>
          )}
          ...
          <CustomAlert
            ...
            message="We apologize for the inconvenience. Our email and contact number services will be unavailable for the next 24 hours. Should you have any questions or concerns, please do not hesitate to reach out to us via email at support@transfarmers.com. We appreciate your understanding and patience."
