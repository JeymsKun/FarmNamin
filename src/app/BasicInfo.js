...
const ProfileSetUp = () => {
  ...
  const handleInformationSubmit = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push("/Introduction?role=" + userRole + "&name=" + FirstName);
      }, 2000);
    } catch (error) {
      ...
      <View style={styles.container}>
        ...
        <View
          style={[
            styles.inputContainer,
            middleNameFocused &&
              (!isValidName(MiddleName) || MiddleName.length === 0) &&
              styles.errorBorder,
          ]}
        >
          <TextInput
        ...
        <View
          style={[
            styles.inputContainer,
            ageFocused && Age.length === 0 && styles.errorBorder,
          ]}
        >
          <TextInput
            style={styles.text}
        ...
        <View style={styles.birthdateContainer}>
          <TouchableOpacity
            ...
            style={[
              ...
              birthDay.length === 0 && isDateCanceled && styles.errorBorder,
            ]}
          >
            <Text
              style={[styles.birthdateText, { color: changeColor(birthMonth) }]}
            >
              {birthMonth || "Month"}
            </Text>
            {!birthMonth && (
          ...
          >
            <Text
              style={[styles.birthdateText, { color: changeColor(birthDay) }]}
            >
              {birthDay || "Day"}
            </Text>
          </View>
          ...
          <View
            style={[
              styles.pickerSection,
              birthYear.length === 0 && isDateCanceled && styles.errorBorder,
            ]}
          >
            <Text
              style={[styles.birthdateText, { color: changeColor(birthYear) }]}
            >
              {birthYear || "Year"}
            </Text>
          </View>
        ...
        {errors.gender && (
          <Text style={styles.errorText}>* Gender selection is required</Text>
        )}
        ...
        <View style={styles.footerButtons}>
          ...
          <TouchableOpacity
            ...
            onPress={handleInformationSubmit}
          >
          ...
          <View style={styles.modalOverlay}>
            <View
              style={[
                ...
                { borderColor: modalType === "success" ? "green" : "red" },
              ]}
            >
              <Text
                style={[
