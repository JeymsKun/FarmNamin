  ...
  const handleSignUpSubmit = async () => {
    ...
    try {
      ...
      if (!isStrongPassword(password)) {
        showAlert(
          "Error",
          "Password must be at least 12 characters, including an uppercase letter, a number, and a special character."
        );
        return;
      }
      ...
      setTimeout(() => {
        router.push("/BasicInfo?userId=" + authData.user.id + "&role=" + role);
      }, 3000);
    } catch (error) {
          ...
          <View style={styles.inputWrapper}>
            ...
            >
              ...
              {password && !isStrongPassword(password) && (
                <Text style={styles.errorLongText}>
                  * Password must be 12+ chars, an uppercase, number, and
                  special char.
                </Text>
              )}
            </View>
          ...
          <View style={styles.checkboxContainer}>
            <View style={styles.checkboxWrapper}>
              ...
              <TouchableOpacity onPress={() => router.push("/legal/Terms")}>
                <Text
                  style={[styles.link, { color: agree ? "white" : "blue" }]}
                >
