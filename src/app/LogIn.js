        ...
        if (user) {
          if (user.role !== role) {
            ...
            if (!user.is_info_complete) {
              router.push("/BasicInfo?userId=" + user.id_user);
            } else {
              router.push("/HomeTabs?role=" + role);
            }
          }
        }
      }
      ...
      >
        ...
        <View style={styles.container}>
          ...
          <View style={styles.inputWrapper}>
            ...
            <View
              style={[
                ...
                (errorEmail || (emailFocused && email.length === 0)) &&
                  styles.errorBorder,
              ]}
            >
              <TextInput
            ...
            <View
              style={[
                ...
                (errorPassword || (passwordFocused && password.length === 0)) &&
                  styles.errorBorder,
              ]}
            >
              <TextInput
          ...
          <View style={styles.signUpContainer}>
            ...
            <TouchableOpacity
              onPress={() => router.push("/SignUp?role=" + role)}
            >
